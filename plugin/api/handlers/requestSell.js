...
angular.module('owsWalletPlugin.apiHandlers').service('requestSell', function(coinbaseService,
  ...
  root.respond = function(message, callback) {
    ...
    coinbaseService.sellRequest(accountId, data).then(function(response) {
